...
import (
	...
	"std/omkesh/Practice/SatTV/pkg/models"
	service "std/omkesh/Practice/SatTV/pkg/service"
)
...
func (h HandlerStruct) Recharge(user *models.User) {
	...
	amount, err := strconv.Atoi(char) //strconv.Atoi(charstrings.TrimSuffix(char, "\n"))
	if err != nil {
